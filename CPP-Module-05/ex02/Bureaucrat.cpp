...
/*   Updated: 2024/11/27 16:55:14 by hmrabet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::executeForm(AForm const& form)
{
	...
	{
		std::cerr << this->name << " couldn’t execute " << form.getName() << " because " << this->name << e.what() << std::endl;
	}
	catch(const AForm::NotSignedException &e)
	{
		std::cerr << this->name << " couldn’t execute " << form.getName() << " because " << form.getName() << e.what() << std::endl;
	}
