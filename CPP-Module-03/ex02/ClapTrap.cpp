...
/*   Updated: 2024/06/21 05:58:42 by hmrabet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "ClapTrap Default constructor called" << std::endl << std::flush;
}

ClapTrap::ClapTrap(std::string name) : name(name), points(10), energyPoints(10), attackDamage(0)
{
	std::cout << "ClapTrap Parameterized constructor called" << std::endl << std::flush;
}
...
{
	std::cout << "ClapTrap Copy constructor called" << std::endl << std::flush;
}
...
{
	std::cout << "ClapTrap Destructor called" << std::endl << std::flush;
}
